...
<div class="bootstrap-wrapper">
  ...
  <div class="row"> 
    ...
    <div class="col-lg-1 col-md-1 col-sm-12 col-xs-12" id="dg">
        <a href="https://www.marketful.mx/ml_listings/atributos" target="_blank"><button id="boton_dg"> Modificar Atributos</button></a>
    </div>
    <div class="col-lg-1 col-md-1 col-sm-12 col-xs-12" id="dg">
        <a href="https://www.marketful.mx/woo_listings/inventario_y_precio" target="_blank"><button id="boton_dg"> Modificar Inventario</button></a>
    </div>
