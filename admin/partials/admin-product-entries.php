...
<div style="width: 100%; overflow: scroll;">
  <table id="tabla" class="table stripe tableMK" style="max-width: 100%; overflow: scroll;">
  <thead >
    <tr>
...
<div id="registros" style="max-width: 100%; overflow: scroll; max-height: 65vh;" >
  <table id="tabla" class="table stripe tableMK" >
    
    <tbody id="tbody_productos" style="overflow: auto;">
